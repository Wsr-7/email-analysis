...
import { buildQueueState, ensureClassifications, matchesIgnoredSender } from "../security/classification";
import { type Locale, mergeStringLists, parseFolders, getLocaleFromConfig, buildSecuritySettings, buildClassificationKeywords, buildDefaultRedactionPolicy } from "../shared/config-utils";
import { getLabels, buildCategoryLabels } from "../ui/dashboard-labels";
...
import { buildBatchDigestMarkdown, pruneMailIndex, type StoredMail } from "../storage/mail-store";
...
import { redactStoredMails, redactThreadForPrompt } from "../security/redaction";
import { applyReplyTemplateToAnalysis } from "./reply-template";
import { buildThreadGateDecision, buildMailSecurityDecisionMap, canAnalyzeMail } from "../security/security-gate";
...
import type { AppDataStore } from "../storage/app-data";
